...
public class ajouter_patient extends ActionBarActivity implements OnClickListener{
    ...
    //testing on Emulator:
    private static final String AJOUTER_PATIENT_URL =  "http://cheerup-backup.esy.es/server/ajouterPatient.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAjouter = (Button)findViewById(R.id.ajouterPatient);
    ...
    class CreateUser extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ajouter_patient.this);
            pDialog.setMessage("Ajoutant Patient...");
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            if (file_url != null){
                Toast.makeText(ajouter_patient.this, file_url, Toast.LENGTH_LONG).show();
            }
        }
    }
}
